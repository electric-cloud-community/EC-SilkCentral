...
# silkCentral.cgi -
#
# Get/set EC-SilkCentral configuration info for UI
#
...
################################
# getCfgList - Return the list of configurations from SilkCentral
#
# Arguments:
#   -
#
...
sub getCfgList {
    ...
    my $gcfg = new ElectricCommander::PropDB($::ec,"/projects/@PLUGIN_NAME@/silkCentral_cfgs");
    ...
    foreach my $cfg (keys  %cfgs) {
        my $url = $gcfg->getCol("$cfg/silkCentral_url");
        $xml .= "  <cfg>\n";
        $xml .= "     <name>$cfg</name>\n";
