...
/**
 * Create SilkCentral Configuration.
 */
    ...
    extends InternalFormBase
{
    ...
    {
        super("New SilkCentral Configuration", "SilkCentral Configurations");
    ...
    @Override protected void load()
    {
        ...
        loader.setCustomEditorPath("/plugins/EC-SilkCentral"
                + "/project/ui_forms/SilkCentralCreateConfigForm");
        loader.load();
        clearStatus();
    }
