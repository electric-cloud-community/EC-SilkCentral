...
// SilkCentralConfigList.java --
//
// SilkCentralConfigList.java is part of ElectricCommander.
//
...
public class SilkCentralConfigList
{

    //~ Instance fields --------------------------------------------------------

    private final Map<String, SilkCentralConfigInfo> m_configInfo =
        new TreeMap<String, SilkCentralConfigInfo>();
    ...
    public void addConfig(
            ...
            String configUrl)
    {
        m_configInfo.put(configName, new SilkCentralConfigInfo(configUrl));
    }
    ...
    private class SilkCentralConfigInfo
    {
        ...
        public SilkCentralConfigInfo(String url)
        {
            m_url = url;
        }
    }
