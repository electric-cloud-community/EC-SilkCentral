...
my $xpath = $ec->getProperty("/myProject/silkCentral_cfgs/$opts->{config}");
...
my $cfg = new ElectricCommander::PropDB($ec,"/myProject/silkCentral_cfgs");
